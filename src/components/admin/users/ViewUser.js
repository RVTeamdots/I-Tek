          ...
          {offenderDetails && offenderDetails.data && (
            <div>
              <section className="content-header">
                <h1>
                  {" "}
                  <b>{offenderDetails.data.name} </b> Details
                </h1>
              </section>
                      ...
                      <div className="col-md-12">
                        <h6 className="sub-heading">
                          ...
                          {role === "police" && (
                            <Link
                              to={
                                Routes.ADMIN_USERS_EDIT + "/" + params.crime_id
                              }
                            >
                              {" "}
                              <i
                    ...
                    <div className="row">
                      <div className="col-md-5">
                        <div className="crime-form">
                          ...
                          <p>Nationality: {offenderDetails.data.nationality}</p>
                      ...
                      <div className="col-md-5">
                        <div className="crime-form">
                          ...
                          <p>Passport NO.: {offenderDetails.data.passportNo}</p>
                          <p>
                            Driving License NO.:{" "}
                          ...
                          <p>
                            National ID NO.: {offenderDetails.data.nationalIdNo}
                          </p>
                          <p>
                            Issuing Authority:{" "}
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-5">
                        <div className="crime-form">
                          ...
                          <p>Expiry Date: {offenderDetails.data.expiryDate}</p>
                        </div>
                      </div>
                    </div>
                    <div className="row">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-5">
                        <div className="crime-form">
                          ...
                          <p>
                            Police Safe No: {offenderDetails.data.policeSafeNo}
                          </p>
                          <p>
                            PoliceReleaseDate:{" "}
                    ...
                    <div className="row">
                      <div className="col-md-5">
                        <div className="crime-form">
                          ...
                          <p>
                            Guarantor Name: {offenderDetails.data.guarantorName}
                          </p>
                    ...
                    <div className="row">
                      <div className="col-md-5">
                        <div className="crime-form">
                          ...
                          <p>
                            Prison Safe No: {offenderDetails.data.prisonSafeNo}
                          </p>
                        </div>
                      </div>
                      <div className="col-md-5">
                        <div className="crime-form">
                          ...
                          <p>
                            Prison Address: {offenderDetails.data.prisonAddress}
                          </p>
                          <p>Prisoner No: {offenderDetails.data.prisonerNo}</p>
                          <p>
                            Prison Release Date:{" "}
